...
def dynamic_group_values(df, column, window=7):
    """
...
def main(args):
    ...
    for ref, group in ref_groups:
        ...
        group = dynamic_group_values(group, 'Pos')
        group = dynamic_group_values(group, 'motif')
...
def argparser():
    ...
    parser.add_argument(
        "input_motif",
        help="tab-separated alignment motifs and counts",
    )
    parser.add_argument(
        "min_cluster_size",
        type=int,
